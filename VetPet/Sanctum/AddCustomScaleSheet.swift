...
struct AddCustomScaleSheet: View {
    ...
    private let iconOptions = [
        "heart.fill", "drop.fill", "flame.fill", "leaf.fill", "brain.head.profile",
        "eye.fill", "ear.fill", "pawprint.fill", "figure.walk", "bed.double.fill",
        "sun.max.fill", "moon.fill", "thermometer.medium", "gauge.medium"
    ]
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        TextField("", text: $name)
                            .placeholder(when: name.isEmpty) {
                                Text("e.g. Hydration, Sleep quality")
