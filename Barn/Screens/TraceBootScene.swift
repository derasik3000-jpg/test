...
final class TraceBootScene: UIViewController {
    ...
    private func startAnimations() {
        ...
        // Не завершаем автоматически - будем управлять завершением извне
        // Экран загрузки остается видимым до вызова onComplete вручную
    }
    
    // Метод для ручного завершения экрана загрузки
